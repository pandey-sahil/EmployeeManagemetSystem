                ...
                <form className="flex flex-wrap w-full items-start justify-between ">
                    <div className="w-1/2">
                        <div>
                            ...
                            <input className="text-sm py-1 px-2  w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4" type="text" placeholder="Write the title" />
                        </div>
                        <div>
                    ...
                    <div className="w-2/5 flex flex-col items-start">
                        ...
                        <textarea className="w-full h-44 text-sm py-1 px-2 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4" name="" id="" ></textarea>
                        <button className="bg-emerald-500 py-3 hover:bg-emerald-600 px-5 rounded w-full text-sm mt-4">Create Task</button>
                    </div>
                </form>
            </div>
